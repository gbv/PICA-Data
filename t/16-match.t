...

{
    ...
    is_deeply($match, ['http://example.org/ABC'], 'match field force_array');
}
...
{
    my $match = pica_match($record, '009Qz', split => 1, nested_arrays => 1);
    is_deeply($match, [['B', 'C']], 'match subfield split nested_arrays');
}
...

{
    ...
    is_deeply($match, ['1234-5678', '1011-1213'], 'match field force_array');
}
